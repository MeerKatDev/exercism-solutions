defmodule FileSniffer do
  ...
  def type_from_binary(<<head::binary-size(8), _::binary>>) do
    case head do
      <<0x7F, 0x45, 0x4C, 0x46, _::binary-size(4)>> -> @media_types["exe"]
      <<0x42, 0x4D, _::binary-size(6)>> -> @media_types["bmp"]
      <<0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A>> -> @media_types["png"]
      <<0xFF, 0xD8, 0xFF, _::binary-size(5)>> -> @media_types["jpg"]
      <<0x47, 0x49, 0x46, _::binary-size(5)>> -> @media_types["gif"]
    end
  end
